#include "OpenCLWrapper/Platform.h"
...
Platform::Platform(const std::string& platformName) {
  unsigned int platformsNumber = checkPlatforms();
  initPlatformFromName(platformsNumber, platformName);
}
...
void Platform::initPlatformFromName(unsigned int platformsNumber,
                                    const std::string& platformName) { 
  platformId = queryPlatformIdFromName(platformsNumber, platformName);
  initDevicesAndContext();
}
...
cl_platform_id Platform::queryPlatformIdFromName(
                         unsigned int platformsNumber,
